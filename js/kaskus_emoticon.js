...
if (a) {
	...
	for (i = 0; i < b.length; i++) {
		if (b.item(i).getAttribute('CLASS') == 'comment-content') {
			...
			bh_b_smly = bh_b_smly.replace(/:(/gi, "<img src='https://googledrive.com/host/0B7H_GQEvKCj1SmIxOXhHalV2ZVE/baeud.gif' alt='' class='kaskus'/>");
			...
			bh_b_smly = bh_b_smly.replace(/^_^/gi, "<img src='https://googledrive.com/host/0B7H_GQEvKCj1SmIxOXhHalV2ZVE/enjoy.gif' alt='' class='kaskus'/>")
